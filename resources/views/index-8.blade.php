                ...
                <div class="carousel-caption banner-slider-inner d-flex h-100 text-center">
                    <div class="carousel-content container">
                        <div class="text-center">
                            ...
                            <a data-animation="animated fadeInUp delay-10s" href="https://213matching.futurejunction.co.jp/" class="btn btn-lg btn-round btn-theme">私たちについて</a>
                    ...
                    <div class="property-box">
                        <div class="property-thumbnail">
                            <a href="properties-details.html" class="property-img">
                                ...
                                <img src="http://placehold.it/350x233" alt="property-5" class="img-fluid">
                            </a>
                            <div class="property-overlay">
                                <a href="properties-details.html" class="overlay-link">
                                    <i class="fa fa-link"></i>
                    ...
                    <div class="property-box">
                        <div class="property-thumbnail">
                            <a href="properties-details.html" class="property-img">
                                ...
                                <img src="http://placehold.it/350x233" alt="property-6" class="img-fluid">
                            </a>
                            <div class="property-overlay">
                                <a href="properties-details.html" class="overlay-link">
                                    <i class="fa fa-link"></i>
                    ...
                    <div id="propertiesDetailsSlider" class="carousel properties-details-sliders slide"> -->
                       ...
                       <!--  <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="http://placehold.it/555x370" class="img-fluid" alt="property-4">
                            </div>
                            <div class="item carousel-item" data-slide-number="1">
                                <img src="http://placehold.it/555x370" class="img-fluid" alt="property-6">
                            </div>
                            <div class="item carousel-item" data-slide-number="2">
                                <img src="http://placehold.it/555x370" class="img-fluid" alt="property-1">
                            </div>
                            <div class="item carousel-item" data-slide-number="4">
                                <img src="http://placehold.it/555x370" class="img-fluid" alt="property-5">
                            </div>
                            <div class="item carousel-item" data-slide-number="5">
                                <img src="http://placehold.it/555x370" class="img-fluid" alt="property-8">
                            </div>
...
<!-- div class="pricing-tables content-area-17">
    <div class="container">
        <div class="main-title">
            <h1>Price Tables</h1>
        </div>
            ...
            <div class="col-lg-4 wow fadeInLeft delay-04s" >
                <div class="pricing">
                    ...
                    <div class="content">
                        ...
                        <div class="button"><a href="pricing-tables-1.html" class="btn btn-border btn-sm">Get started</a></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 wow fadeInDown delay-04s" >
                <div class="pricing featured">
                    ...
                    <div class="content">
                        ...
                        <div class="button"><a href="pricing-tables-1.html" class="btn btn-color btn-sm">Get started</a></div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 wow fadeInLeft delay-04s">
                <div class="row blog-list">
                    <div class="col-lg-5 col-md-12 col-pad ">
                        <div class="photo">
                            <img src="http://placehold.it/225x270" alt="blog-4" class="img-fluid fit-cover h-100">
                            <div class="date-box">
                                <h5>03</h5>
                                <h5>May</h5>
                            </div>
            ...
            <div class="col-lg-6 col-md-6 wow fadeInRight delay-04s">
                <div class="row blog-list">
                    <div class="col-lg-5 col-md-12 col-pad ">
                        <div class="photo">
                            <img src="http://placehold.it/225x270" alt="blog-6" class="img-fluid fit-cover h-100">
                            <div class="date-box">
                                <h5>03</h5>
                                <h5>May</h5>
                            </div>
            ...
            <div class="multi-carousel-inner">
                <div class="item">
                    <div class="pad15">
                        ...
                        <img src="http://placehold.it/136x50" alt="brand">
                    </div>
                </div>
                <div class="item">
                    <div class="pad15">
